...
# dataset settings
dataset_type = "WaymoPlusPlusDataset"
data_root = "/media/staging1/dhwang/Waymo/pointcept_derived_flow_color"  # Update with your dataset path
ignore_index = -1
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        transform=[
            #dict(type="RandomDropout", dropout_ratio=0.88, dropout_application_ratio=1),
            ...
            dict(
                ...
                hash_type="fnv",
                mode="train",
                keys=("coord","strength", "color", "flow","sam"),
    ...
    test=dict(
        ...
        transform=[
            ...
            dict(
                ...
                hash_type="fnv",
                mode="train",
                keys=("coord", "strength", "segment","color","sam"),
                return_inverse=True,
            ),
        ],
        test_mode=True,
...
# Tester
test = dict(type="WaymoPPClusterTester", verbose=True)